...
import { FaArrowLeft, FaExternalLinkAlt, FaStethoscope, FaNotesMedical, FaUserMd, FaHospital, FaHeartbeat, FaFileMedical } from 'react-icons/fa';
...
const EmaPage = () => {
    ...
    const features = [
        ...
        {
            icon: FaShieldAlt, // Importing FaShieldAlt from react-icons/fa in the import statement above if not already present
        ...
        <div ref={containerRef} className="min-h-screen bg-[#0f172a] text-[#e2e8f0] font-sans selection:bg-[#10b981] selection:text-white pb-20">
            ...
            <header className="container mx-auto px-6 mt-12 mb-24">
                <div className="max-w-4xl">
                    ...
                    <h1 className="text-6xl md:text-8xl font-black uppercase tracking-tighter mb-8 bg-clip-text text-transparent bg-gradient-to-r from-emerald-100 to-emerald-600 reveal-element">
                        Ema
                    </h1>
                    <h2 className="text-2xl md:text-4xl font-bold text-[#10b981] mb-6 reveal-element">
            ...
            <section className="container mx-auto px-6 mb-32 reveal-element">
                <div className="bg-[#1e293b] p-12 rounded-3xl border border-white/5">
                    ...
                    <p className="text-2xl leading-relaxed opacity-90">
                        La práctica médica moderna exige eficiencia y precisión.
                        <strong>Ema</strong> digitaliza el consultorio médico, eliminando el papeleo y centralizando la información clínica
                        en una interfaz intuitiva y segura, accesible desde cualquier dispositivo.
                    </p>
                </div>
            </section>
            ...
            <section className="container mx-auto px-6 mb-32">
                <h2 className="text-4xl font-bold mb-16 border-b border-white/10 pb-8 reveal-element">CARACTERÍSTICAS</h2>
...
// Start of Selection
import { FaShieldAlt } from 'react-icons/fa'; // Ensure import is present if used
// End of Selection
